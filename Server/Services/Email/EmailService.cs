...
public class EmailService(IOptions<PettyBotEmailData> _pettyBotMailData)
{
    public async Task SendEmailAsync(string email, string subject, string message)
    {
        var emailMessage = new MimeMessage();
        emailMessage.From.Add(new MailboxAddress(IdentityResource.SiteAdministration, _pettyBotMailData.Value.Email));
        ...
        await client.AuthenticateAsync(_pettyBotMailData.Value.Email, _pettyBotMailData.Value.ApplicationPassword);
