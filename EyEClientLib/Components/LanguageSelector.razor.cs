...
public partial class LanguageSelector
{
    ...
    {
        get => _currentLanguageData;
        set
        {
            if (_currentLanguageData != value)
            {
                _currentLanguageData = value;
                Localstorage.SetCultureAsync(value.CultureInfo);
                Navigation.NavigateTo(Navigation.Uri, forceLoad: true);
            }
        }
    }

    public class LanguageData(string name, string imageSource, CultureInfo cultureInfo)
    {
